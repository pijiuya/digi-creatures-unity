        ...
        private void CameraRotation()
{
    ...
    CinemachineCameraTarget.transform.rotation = Quaternion.Euler(
        ...
        {
            if (!isActiveAndEnabled || _controller == null || animationEvent.animatorClipInfo.weight <= 0.5f)
            {
                return;
            }
        ...
        {
            if (!isActiveAndEnabled || _controller == null || LandingAudioClip == null || animationEvent.animatorClipInfo.weight <= 0.5f)
            {
                return;
            }
